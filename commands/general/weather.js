  ...
  serverSpecific: ["523242594860269568", "390264660789690388"],
    ...
    if(args[1] == "today" || args[1] == "tomorrow") {
      try {
        ...
        console.error(err)
        msg.edit(this.errorMessage("error", "Error in fetching the weather.", "weather:0"))
      }
...
`
        ...
        console.error(err)
        msg.edit(this.errorMessage("error", "Error in fetching the current weather.", "weather:1"))
      }
    }
	},
